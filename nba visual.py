...
grouped_shots_df = pd.read_csv("C:/Users/15165/Pictures/New folder/fun/nba visuals/league_shots_by_dist.csv")


# In[4]:


grouped_shots_df.head(20)
...
import pickle
with open('C:/Users/15165/Pictures/New folder/fun/nba visuals/league_hexbin_stats.pickle', 'rb') as f:league_hexbin_stats = pickle.load(f)


# In[11]:


print(league_hexbin_stats.keys())
...
from copy import deepcopy
teamname = 'GSW'
with open('C:/Users/15165/Pictures/New folder/fun/nba visuals/gsw_hexbin_stats.pickle', 'rb') as f:
